...
export const addKonlpyTextData = () => {
  ...
  const {
    mutate,
    data: konlpyTaskId,
    isLoading: isKonlpyTextLoading,
    isSuccess: isKonlpyTextSuccess,
    isError: isKonlpyTextError,
  } = useMutation(addKonlpyText, {
    onError: () => {
...
export const sendKonlpyPollingData = () => {
  ...
  const {
    mutate,
    data: konlpyState,
    isSuccess: isKonlpyPollingSuccess,
    isError: isKonlpyPollingError,
  } = useMutation(sendKonlpyPolling, {
    onError: (e) => {
  ...
  return {
    isKonlpyPollingSuccess,
    isKonlpyPollingError,
    konlpyState,
    sendKonlpyPollingState,
  };
};
...
export const getKonlpyDrawingData = () => {
  ...
  const {
    mutate,
    data: konlpyImg,
    isSuccess: isGetKonlpyImgSuccess,
    isError: isGetKonlpyImgError,
  } = useMutation(getKonlpyDrawing, {
    onError: (e) => {
