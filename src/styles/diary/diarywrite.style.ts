...
export const Keyword = styled.div<KeywordProps>`
  ...
  background-color: ${(props: any) =>
    !props.isSelected ? props.theme.btnColor : '#FFFFFF'};
  ...
  > p {
    ...
    -webkit-text-stroke: 0.2px
      ${(props: any) => (!props.isSelected ? '#FFFFFF' : props.theme.btnColor)};
    color: ${(props: any) =>
      !props.isSelected ? '#FFFFFF' : props.theme.btnColor};
    display: flex;
    justify-content: center;
    align-items: center;
  }
...
export const LeftCursor = styled(CommonCursorProps)`
  border-right-width: ${(props) =>
    props.cursor === 0 && props.idx === 0 ? '3px' : '0px'};
  margin-right: 3px;
`;

export const RightCursor = styled(CommonCursorProps)`
  border-right-width: ${(props) =>
    props.cursor - 1 === props.idx && props.cursor > 0 ? '3px' : '0px'};
  margin-left: 3px;
`;
